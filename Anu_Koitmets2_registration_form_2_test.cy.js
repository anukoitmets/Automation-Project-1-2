...
describe('Section 2: Visual tests', () => {
    ...
    it.only('"Esita taotlus" button works correctly', () => {
        cy.visit('https://www.cooppank.ee/kodulaen')
    
        // Make sure that "Esita taotlus" button is enabled and leads to the identifying process
        cy.get('#btn btn-primary btn-full-width').should('be.enabled').click()
        cy.log('Navigates to the identifying page')
    })
